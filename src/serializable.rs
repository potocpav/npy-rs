...
impl Serializable for i8 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<i1".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 1 }
    #[inline]
...
impl Serializable for i16 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<i2".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 2 }
    #[inline]
...
impl Serializable for i32 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<i4".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 4 }
    #[inline]
...
impl Serializable for i64 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<i8".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 8 }
    #[inline]
...
impl Serializable for u8 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<u1".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 1 }
    #[inline]
...
impl Serializable for u16 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<u2".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 2 }
    #[inline]
...
impl Serializable for u32 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<u4".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 4 }
    #[inline]
...
impl Serializable for u64 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<u8".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 8 }
    #[inline]
...
impl Serializable for f32 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<f4".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 4 }
    #[inline]
...
impl Serializable for f64 {
    #[inline]
    fn dtype() -> DType {
        DType::Plain { ty: "<f8".parse().unwrap(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 8 }
    #[inline]

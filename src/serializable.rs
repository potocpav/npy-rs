...
impl Serializable for i8 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<i1".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 1 }
    #[inline]
...
impl Serializable for i16 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<i2".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 2 }
    #[inline]
...
impl Serializable for i32 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<i4".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 4 }
    #[inline]
...
impl Serializable for i64 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<i8".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 8 }
    #[inline]
...
impl Serializable for u8 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<u1".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 1 }
    #[inline]
...
impl Serializable for u16 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<u2".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 2 }
    #[inline]
...
impl Serializable for u32 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<u4".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 4 }
    #[inline]
...
impl Serializable for u64 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<u8".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 8 }
    #[inline]
...
impl Serializable for f32 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<f4".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 4 }
    #[inline]
...
impl Serializable for f64 {
    #[inline]
    fn dtype() -> DType {
        DType { ty: "<f8".to_string(), shape: vec![] }
    }
    #[inline]
    fn n_bytes() -> usize { 8 }
    #[inline]
